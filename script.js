        ...
        fetch('config.json')
            ...
            .then((config) => {
                ...
                fetch('scenes.json')
                    ...
                    .then(function (extraScenes) {
                        if (!extraScenes || typeof extraScenes !== 'object') return;
                        Object.keys(extraScenes).forEach(function (id) {
                            if (!configData.scenes[id]) {
                                configData.scenes[id] = extraScenes[id];
                            }
                        });
                        sceneKeys = Object.keys(configData.scenes);
                        totalScenes = sceneKeys.length;
